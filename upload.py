...
if __name__ == "__main__":
	...
	# parser.add_argument("--url_server", type=str, default="www", choices=["us", "www"], help="Specify the prefix of url (www or us)")
	# args = parser.parse_args()
    # python3 ./uploader.py -i 'your sessionid' -p ./download/test.mp4 -t  测试上传

	# python3 ./uploader.py -i '47348cdd04c5afec1352a96ccce978fc' -p ./video.mp4 -t  测试上传
	...
	session_id = "47348cdd04c5afec1352a96ccce978fc"
	file = "/video.mp4"
